...
class LifeCfgVehicles {
    ...
    */
    ...
    class C_Boat_Transport_02_F {
        vItemSpace = 100;
        conditions = "license_civ_boat || {!(playerSide in [east,civilian])}";
        price = 22000;
        textures[] = {
            { "Civilian", "civ", {
    ...
    class C_Plane_Civil_01_F {
        vItemSpace = 75;
        conditions = "license_civ_pilot || {!(playerSide in [east,civilian])}";
        price = 150000;
        textures[] = {
    ...
    class O_Truck_03_transport_F {
        vItemSpace = 285;
        conditions = "license_civ_trucking || {!(playerSide in [east,civilian])}";
        price = 200000;
        textures[] = { };
    };
