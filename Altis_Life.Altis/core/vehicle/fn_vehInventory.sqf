...
_tInv = CONTROL(IDD_TRUNKMENU,IDC_TRUNKMENU_TRUNKGEAR);
_pInv = CONTROL(IDD_TRUNKMENU,IDC_TRUNKMENU_PLAYERGEAR);
lbClear _tInv;
lbClear _pInv;
...
ctrlSetText[IDC_TRUNKMENU_VEHICLEWEIGHT,format ["Weight: %1/%2",(_veh_data select 1),(_veh_data select 0)]];
