...
if ((lbCurSel IDC_GANGMENU_COLORLIST) isEqualTo -1) exitWith {hint localize "STR_GNOTF_SelectPerson"};
_unit = call compile format ["%1",CONTROL_DATA(IDC_GANGMENU_COLORLIST)];
