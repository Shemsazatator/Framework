        ...
        if (!((headgear _x) in _masks || (goggles _x) in _masks || (uniform _x) in _masks)) then {
            if (count _sPos > 1 && {_distance < 15}) then {
              _text = switch true do {
                  case (side _x isEqualTo west && {!isNil {_x getVariable "rank"}}): {format [localize "STR_NAMETAG_West",switch ((_x getVariable "rank")) do {
                  ...
                  },_x getVariable ["realname",name _x],_x getVariable "life_level"]};
                  case (_x in (units group player) and {playerSide isEqualTo east}): {format [localize "STR_NAMETAG_East",(_x getVariable ["realname",name _x]),_x getVariable "life_level"]};
                  case (side _x isEqualTo independent): {format [localize "STR_NAMETAG_Independent",_x getVariable ["realname",name _x],_x getVariable "life_level"]};
                  case (_x in (units group player) and {playerSide isEqualTo civilian}): {format [localize "STR_NAMETAG_Civilian",(_x getVariable ["realname",name _x]),_x getVariable "life_level"]};
                  default {
