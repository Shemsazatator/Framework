class life_admin_menu {
    ...
    class controls {
        ...
        class PlayerBInfo: Life_RscStructuredText {
            idc = IDC_ADMINMENU_PLAYERLISTINFO;
            text = "";
