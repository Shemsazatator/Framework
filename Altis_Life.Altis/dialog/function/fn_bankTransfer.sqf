...
_unit = call compile format ["%1",CONTROL_DATA(IDC_BANKMENU_PLAYERLIST)];
if (isNull _unit) exitWith {};
if ((lbCurSel IDC_BANKMENU_PLAYERLIST) isEqualTo -1) exitWith {hint localize "STR_ATM_NoneSelected"};
