...
*/
private ["_uid","_side","_value","_value1","_value2","_value3","_mode","_query"];
...
switch _mode do {
    ...
    case 8: {
        _value1 = [_this,2,0,[0]] call BIS_fnc_param;
        _value2 = [_this,4,0,[0]] call BIS_fnc_param;
        _value3 = [_this,6,0,[0]] call BIS_fnc_param;
        _value1 = [_value1] call HC_fnc_numberSafe;
        _value2 = [_value2] call HC_fnc_numberSafe;
        _value3 = [_value3] call HC_fnc_numberSafe;
        _query = format ["UPDATE players SET level='%1', experience='%2', skillPoints='%3' WHERE pid='%4'",_value1,_value2,_value3,_uid];
    };
};
