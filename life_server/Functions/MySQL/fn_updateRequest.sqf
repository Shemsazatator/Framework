...
*/
private ["_uid","_side","_cash","_bank","_level","_experience","_skillPoints","_licenses","_gear","_stats","_name","_alive","_position","_query","_thread"];
...
switch _side do {
    ...
    case east: {_query = format ["UPDATE players SET name='%1', cash='%2', bankacc='%3', level='%4', experience='%5', skillPoints='%6', civ_licenses='%7', civ_gear='%8', arrested='%9', civ_stats='%10', civ_alive='%11', civ_position='%12', playtime='%13' WHERE pid='%14'",_name,_cash,_bank,_level,_experience,_skillPoints,_licenses,_gear,[_this select 8] call DB_fnc_bool,_stats,[_alive] call DB_fnc_bool,_position,_playtime_update,_uid];};
    ...
    case civilian: {_query = format ["UPDATE players SET name='%1', cash='%2', bankacc='%3', level='%4', experience='%5', skillPoints='%6', civ_licenses='%7', civ_gear='%8', arrested='%9', civ_stats='%10', civ_alive='%11', civ_position='%12', playtime='%13' WHERE pid='%14'",_name,_cash,_bank,_level,_experience,_skillPoints,_licenses,_gear,[_this select 8] call DB_fnc_bool,_stats,[_alive] call DB_fnc_bool,_position,_playtime_update,_uid];};
};
